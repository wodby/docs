...
Wodby provides a private docker registry `registry.wodby.com` that stores the images built and pushed during your deployments. See [deployment](cicd/third-party.md#push) for how images are pushed to it.
