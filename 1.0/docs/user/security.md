...
Organization owners can require 2FA for every active member under
**Organization > Security**. See [Organization security](../org/security.md)
for setup, enforcement, and member status. Members manage their own
authenticator and recovery codes under **Account > Security**.
