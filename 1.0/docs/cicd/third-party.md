...
See [build-image retention](deploy.md#automatically-clean-unused-build-images) and
[deploying a previous build](deploy.md#deploy-a-previous-build) to manage builds after deployment.
