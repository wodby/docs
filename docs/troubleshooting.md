...
* [Lack of free disk space](/docs/infrastructure/disk/#freeing-disk-space). The amount of free space has to be no less than expected backup size, e.g. database + files backups size     
